...
public class AttachmentMapper extends AbstractFieldMapper<Object> {
            ...
            for (Map.Entry<String, Object> entry : node.entrySet()) {
                ...
                if (fieldName.equals("path")) {
                    ...
                    for (Map.Entry<String, Object> entry1 : fieldsNode.entrySet()) {
                        ...
                        parseField((AbstractFieldMapper.Builder) mapperBuilder, propName, propNode, parserContext);
    ...
    public AttachmentMapper(FieldMapper.Names names, ContentPath.Type pathType, int defaultIndexedChars, Boolean ignoreErrors,
    ...
    public void parse(ParseContext context) throws IOException {
        ...
        context = context.externalValue(parsedContent);
        ...
        if (langDetect) {
            try {
                ...
                context = context.externalValue(language);
        ...
        if (name != null) {
            try {
                context = context.externalValue(name);
        ...
        if (metadata.get(Metadata.DATE) != null) {
            try {
                context = context.externalValue(metadata.get(Metadata.DATE));
        ...
        if (metadata.get(Metadata.TITLE) != null) {
            try {
                context = context.externalValue(metadata.get(Metadata.TITLE));
        ...
        if (metadata.get(Metadata.AUTHOR) != null) {
            try {
                context = context.externalValue(metadata.get(Metadata.AUTHOR));
        ...
        if (metadata.get(Metadata.KEYWORDS) != null) {
            try {
                context = context.externalValue(metadata.get(Metadata.KEYWORDS));
        ...
        if (contentType != null) {
            try {
                context = context.externalValue(contentType);
        ...
        try {
            context = context.externalValue(length);
